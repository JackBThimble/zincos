pub const Font8x8 = struct {
    ...
    /// Returns a glyph for ASCII. Unknown chars return '?'.
    pub fn glyph(c: u8) Glyph {
        return switch (c) {
            ...
            '7' => .{ 0x7E, 0x66, 0x60, 0x30, 0x18, 0x18, 0x18, 0x00 },
            ...
            'f' => .{ 0x38, 0x0C, 0x0C, 0x3E, 0x0C, 0x0C, 0x0C, 0x00 },
            ...
            'j' => .{ 0x30, 0x00, 0x38, 0x30, 0x30, 0x36, 0x36, 0x1C },
            ...
            'r' => .{ 0x00, 0x00, 0x36, 0x1E, 0x06, 0x06, 0x06, 0x00 },
